      ...
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            ...
            properly, therefore problem solving is the most important ability
            any developer could have.
          </p>
          <p>
            While I am proud of my tools, skills and knowledge, I always seek
            out to learn more if possible, as well as utilize my knowledge in
            any way I can.
          </p>
        </div>
